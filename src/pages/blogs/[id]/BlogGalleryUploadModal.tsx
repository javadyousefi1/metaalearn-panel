...
import { useBlogGallery } from '@/hooks';
import {
  BlogGalleryItem,
  GalleryCategory,
  GalleryType,
...
interface BlogGalleryUploadModalProps {
  open: boolean;
  onClose: () => void;
  onSuccess: () => Promise<void>;
  blogId: string;
  editingItem?: BlogGalleryItem | null;
}

export const BlogGalleryUploadModal: React.FC<BlogGalleryUploadModalProps> = ({
  open,
  onClose,
  onSuccess,
  blogId,
  ...
  const { uploadGallery, isUploading } = useBlogGallery();
